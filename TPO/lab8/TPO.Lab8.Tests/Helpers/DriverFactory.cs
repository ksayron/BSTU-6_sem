...
public static class DriverFactory
{
    ...
    {
        var browser = (Environment.GetEnvironmentVariable("GDM_BROWSER") ?? "edge").Trim().ToLowerInvariant();
        var isHeadless = string.Equals(Environment.GetEnvironmentVariable("GDM_HEADLESS"), "1", StringComparison.OrdinalIgnoreCase);
