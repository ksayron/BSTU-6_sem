...
public sealed class SmokeTests : BaseTest
{
    ...
    public void HomePage_ShouldLoadMainElements()
    {
        ...
        Assert.That(HomePage.IsHeaderLoaded(), Is.True, "Header/catalog entry is not visible.");
        Assert.That(HomePage.IsSearchAvailable(), Is.True, "Search input is not visible.");
